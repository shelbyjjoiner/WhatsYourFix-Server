# Generated by Django 4.1.3 on 2022-12-16 21:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hobby', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hobbyists', to='WhatsYourFixApi.hobbies')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WhatsYourFixApi.neurouser')),
            ],
        ),
        migrations.CreateModel(
            name='Posts',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='WhatsYourFixApi.neurouser')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
